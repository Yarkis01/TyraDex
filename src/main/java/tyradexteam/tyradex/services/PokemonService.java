...
public class PokemonService {
     ...
     * @param repo The PokemonRepository instance used for CRUD operations on Pokemon entities.
     */
    ...
    /**
     * Method to retrieve all Pokemon entities from the database. This method interacts with the repository to fetch all records.
